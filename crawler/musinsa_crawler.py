...
def musinsa_brands():
    ...
    brandList = bsObj.find('div',{'class','brand_name_container'}).find_all('div', {'id':'text_list'})
    for brandAlpha in brandList:
        brands = brandAlpha.find_all('li',{'class':'brand_li'})
        for brand in brands:
