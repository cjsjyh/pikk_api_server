...
export async function crawlZara(sourceUrl): Promise<CrawledItemInfo> {
  ...
  let price = parseHtml(htmlCode, "number", "value", ".price._product-price", "span.line-through")
  let saleprice = parseHtml(htmlCode, "number", "value", ".price._product-price", "span.sale")

  if (price == null || price == 0) {
    price = parseHtml(htmlCode, "number", "value", ".price._product-price","span.main-price")
  }
